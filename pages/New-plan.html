<!-- The page that pos up when there are already plans but you just fell like adding a new one -->
...
<head>
    ...
    <title>Stokkpiler | New Plan</title>
</head>
<body>
        ...
        <div class="main-container">
            ...
            <!-- <div class="main-header">
                    ...
                    <div class="personalize">
                        <img class="notification-bell" src="../assets/images/Group 3.svg" alt="">
                        <div class="avatar">
                            <img src="../assets/images/Oval.svg" alt="">
                        </div>
                        <a href="./logout" class="logoutNav">
                            Logout
                        </a>
                    </div>
                </div> -->
                ...
                <div class="main-body">
                        <div class="choose-deposit-option show-div">
                        ...
                        <p class="bottom-text-anchor">
                                Deposit with us and get building materials in return
                        </p>
                    </div>
                  <div class="footer">
