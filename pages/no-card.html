...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/no-card.css">
...
<body>
    <div class="container">
                ...
                <div class="links">
                    ...
                    <div class="link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
                            <path id="Path_419" data-name="Path 419" d="M3,10.778H9.222V3H3ZM3,17H9.222V12.333H3Zm7.778,0H17V9.222H10.778Zm0-14V7.667H17V3Z"/>
                        </svg>
        ...
        <div class="main">
            ...
            <div class="body">
                <div class="no-card">
                    <p class="card-rules">
                        You can only add the local card of your chosen country or a dollar card. If you do not have a Dollar Card, <br> <a  href="https://getbarter.co/" target="_blank" rel="nofollow">click here</a> to get a virtual Dollar Card with GetBarter
                    </p>
                    <p class="add-card">
                        Add card to your account
                    </p>
                    <button class="add-card-btn">
                        <img src="../assets/images/add-1.svg" alt="">
                    </button>
                    ...
                    <div class="card-brands">
                        ...
                        <img src="../assets/images/verve.svg" alt="">
                        <img src="../assets/images/master-card.svg" alt="">
                    </div>
                </div>
                <form method="post" class="hide" action="cards.html">
                    <p class="card-rules">
                        You can only add the local card of your chosen country or a dollar card. If you do not have a Dollar Card, <br> <a href="https://getbarter.co/" target="_blank" rel="nofollow">click here</a> to get a virtual Dollar Card with GetBarter
                    </p>
                    <div class="form-group">
                        <label for="name">Name your Card<span class="required-star">*</span></label>
                        <input type="text" id="name" placeholder="Samuel Fapoun" required>
                        <small>Give your Debit Card a name to help when making a transaction</small>
                    </div>
                    <div class="form-group">
                        <label for="name">Name on Card <span class="required-star">*</span></label>
                        <input type="text" id="card-name" placeholder="Samuel Fapoun" required>
                        <small>The name written on your Debit Card</small>
                    </div>
                    <div class="form-group">
                        <label for="card-number">Card Number<span class="required-star">*</span></label>
                        <input type="text" id="card-number" placeholder="1234-XXXX-XXXX-XXXX" maxlength="19" required>
                        <small>The bold number on your Debit Card</small>
                    </div>
                    <div class="form-group inline">
                        <label for="expiry-date">Expiry Date<span class="required-star">*</span></label>
                        <input type="text" id="expiry-date" placeholder="MM/YY" maxlength="5" required>
                    </div>
                    <div class="form-group inline">
                        <label for="cvv">CVV<span class="required-star">*</span></label>
    ...
    <!--If you add class failure here the failure div will show-->
    <div class="status-background hide status-success">
        <div class="success modal">
            <p>Your card has been successfully added</p>
        ...
        <div class="failure modal">
            ...
            <img src="../assets/images/failure.svg">
            <button class="close-modal">
                <img src="../assets/images/delete-card.svg">
            </button>
        </div>
    </div>
    <script src="../assets/js/no-card.js"></script>
