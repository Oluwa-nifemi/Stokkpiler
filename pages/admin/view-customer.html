...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/view-customer.css">
...
<div class="container">
            ...
            <div class="links">
                ...
                <div class="link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="12.833" height="14" viewBox="0 0 12.833 14">
                        <path id="md-stats" d="M83.5,64h2.333V78H83.5ZM80,73.917h2.333V78H80Zm7-2.333h2.333V78H87Zm3.5-3.5h2.333V78H90.5Z" transform="translate(-80 -64)"></path>
                    </svg>
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="top-cards">
                <div class="user-card">
                    <img src="../../assets/images/user-big.jpg" alt="user picture" class="user-picture">
                ...
                <div class="withdrawn">
                    <p class="withdrawn__header">
                        Materials Withdrawn
                    </p>
                    <div class="withdrawn__content">
                        <div class="units">
                            <p class="withdrawn__content__header">
                                Units of Block
                            </p>
                            <p class="withdrawn__content__value">
                                14,000
                            </p>
                        </div>
                        <div class="bags">
            ...
            <div id="deposited" class="table show">
                ...
                <div class="table__row">
                        <span class="table__serial-number">
                            1.
                        </span>
                        <span>
            ...
            <div id="withdrawn" class="table">
                ...
                <div class="table__row">
                    ...
                    <span>
                            <span class="label">Withdrawal Materials:</span>
                            100 Blocks, 12 Cements
                        </span>
                    <span>
