            ...
            <div class="content">
                <div class="top-bar">
                    ...
                    <div class="top-bar__search">
                        <input class="top-bar__input">
                        <img src="../../assets/images/search.svg" class="top-bar__search-icon" alt="search-icon">
                    </div>
                </div>
                <div class="customer-table">
                    ...
                    <div class="customer-table__row">
                        <span class="customer-table__serial-number">
                            1.
                        </span>
                        ...
                        <span>
                            <span class="label">List of Materials:</span>
                            Block, Cement
                        </span>
                        <span>
                        ...
                        <a href="./view-customer.html" class="customer-table__link">
                            <img src="../../assets/images/eye.svg" alt="password-icon">
                            <span>
                                View Details
                            </span>
                        </a>
